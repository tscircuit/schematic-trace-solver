...
real traces whenever the router finds a clear path. Finally,
`NetLabelTraceJunctionSolver` joins a labeled trace branch to a nearby, aligned
...
5. Copy the input problem and [paste it into the input debugger](https://schematic-trace-solver.vercel.app/?fixture=%7B%22path%22%3A%22site%2Fexamples%2Fexample01.page.tsx%22%7D)
