 ...
 * 4. **Merging Collinear Traces**: Finally, it merges collinear same-net trace segments that are close together into shared lines.
...
export class TraceCleanupSolver extends BaseSolver {
  ...
  private _runMergeCollinearTracesStep() {
    this.outputTraces = mergeCollinearTraces(
