...
import { SameNetSegmentMergeSolver } from "../SameNetSegmentMergeSolver/SameNetSegmentMergeSolver"
...
export class SchematicTracePipelineSolver extends BaseSolver {
  ...
  sameNetSegmentMergeSolver?: SameNetSegmentMergeSolver
  ...
  pipelineDef = [
    ...
    definePipelineStep(
      ...
      (instance) => {
        const traces =
          instance.sameNetSegmentMergeSolver?.getOutput().traces ??
          instance.traceCleanupSolver?.getOutput().traces ??
          instance.traceLabelOverlapAvoidanceSolver!.getOutput().traces
