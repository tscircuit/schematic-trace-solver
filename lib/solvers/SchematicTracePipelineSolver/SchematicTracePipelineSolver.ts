...
export class SchematicTracePipelineSolver extends BaseSolver {
  ...
  pipelineDef = [
    ...
    definePipelineStep(
      ...
      SameNetTraceLineMergeSolver,
      () => [
        // biome-ignore format: keep merge solver ctor args on one line for pipeline grep checks
        {
          inputProblem: this.inputProblem,
          correctedTraceMap: { ...this.traceOverlapShiftSolver!.correctedTraceMap },
          tolerance: 0.01,
        },
      ],
    ),
    definePipelineStep(
      ...
      () => [
        {
          inputProblem: this.inputProblem,
          inputTraceMap: this.sameNetTraceLineMergeSolver!.mergedTraceMap,
        },
      ],
      {
        onSolved: (_solver) => {
    ...
    definePipelineStep(
      ...
      TraceLabelOverlapAvoidanceSolver,
      (instance) => {
        const traceMap = instance.sameNetTraceLineMergeSolver!.mergedTraceMap
