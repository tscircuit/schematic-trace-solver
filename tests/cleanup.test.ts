import { SchematicTracePipelineSolver } from "../SchematicTracePipelineSolver"

/**
 * Test to prove that mergeCollinearSegments correctly collapses 3 collinear points into 2.
 */
function testCleanupLogic() {
  const mockProblem: any = { chips: [], directConnections: [], netConnections: [], availableNetLabelOrientations: {} }
  ...
  const collinearPoints = [
    { x: 10, y: 10 },
    { x: 20, y: 10 }, // Intermediate point should be removed
    { x: 30, y: 10 }
  ]
