...
/**
 * Reproduction test for Issue #79: Two capacitors connected ONLY via net labels (GND, VCC)
 * should not produce trace lines between them. Traces should only be drawn for directConnections.
 */
