...
import source from "./assets/repro-am3352-03-interfaces.circuit.json"
import input from "./assets/repro-am3352-03-interfaces.input.json"

// Full 03-Interfaces sheet from am3352-dev-board-4layer-dogbone.json.
...
test("repro complete AM3352 03-Interfaces sheet", async () => {
  ...
  expect(problem.netConnections).toHaveLength(21)
  ...
  ).toMatchSvgSnapshot(import.meta.path, "repro-am3352-03-interfaces.source")
